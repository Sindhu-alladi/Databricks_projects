...
departments = ["ICU", "OPD", "Emergency", "Surgery", "Radiology", "Pathology"]
...
insurers = [
    ...
    "Care Health Insurance", "Tata AIG Health"
]
...
complaints = [
    ...
    "Swollen legs", "High blood sugar", "Blurred vision"
]
